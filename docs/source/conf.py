...
# -*- coding: utf-8 -*-
#
# PyPlanet documentation build configuration file, created by
...
man_pages = [
	(master_doc, 'pyplanet', 'PyPlanet Documentation',
	 [author], 1)
]
...
texinfo_documents = [
	(master_doc, 'PyPlanet', 'PyPlanet Documentation',
	 author, 'PyPlanet', 'One line description of project.',
	 'Miscellaneous'),
]
