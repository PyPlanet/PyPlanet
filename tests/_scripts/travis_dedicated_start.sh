...
./ManiaPlanetServer /dedicated_cfg=dedicated_cfg.txt /title=TMCanyon@nadeo /game_settings=MatchSettings/matchsettings_1.txt /login=${MP_USER} /password=${MP_PASS} /loadcache
